...
interface ProductBasicInfoModalProps {
  open: boolean;
...
export function ProductBasicInfoModal({
  open,
  product,
  onClose,
  onSuccess,
}: ProductBasicInfoModalProps) {
  ...
  return (
    <Modal
      title={t('products.editBasicInfo')}
      open={open}
      onCancel={onClose}
      onOk={handleSubmit}
