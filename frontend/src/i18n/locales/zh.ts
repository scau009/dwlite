export default {
  ...
  myChannels: {
    title: '销售渠道管理',
    description: '申请和管理您的销售渠道连接',
    availableChannels: '可申请渠道',
    availableChannelsDescription: '浏览并申请您想要接入的销售渠道',
    myChannels: '我的渠道',
    myChannelsDescription: '查看和管理已申请或已接入的销售渠道',
    noAvailableChannels: '暂无可申请的渠道',
    noDescription: '暂无描述',
    apply: '申请',
    applyForChannel: '申请渠道',
    submitApplication: '提交申请',
    applicationSubmitted: '申请已提交',
    applicationRemark: '申请备注',
    applicationRemarkHint: '可选填写附加信息供管理员参考',
    applicationRemarkPlaceholder: '请输入申请备注...',
    ...
    confirmCancel: '确认取消',
    confirmCancelDesc: '确定要取消「{{name}}」的申请吗？',
    applicationCancelled: '申请已取消',
    disable: '停用',
    confirmDisable: '确认停用',
    confirmDisableDesc: '确定要停用渠道「{{name}}」吗？您可以之后重新启用。',
  ...
  channels: {
    ...
    warehouses: {
      ...
      country: '国家',
      priority: '优先级',
      priorityTooltip: '数字越小优先级越高',
      status: '状态',
      remark: '备注',
      available: '可用仓库',
      selectWarehouses: '选择仓库',
      confirmRemove: '确认移除',
      confirmRemoveDesc: '确定移除仓库「{{name}}」？',
      removed: '仓库已移除',
      added: '仓库已添加',
      updated: '配置已更新',
      batchAddSuccess: '成功添加 {{added}} 个仓库，跳过 {{skipped}} 个',
  ...
  merchantChannels: {
    ...
    merchant: '商户',
    channel: '销售渠道',
    fulfillmentType: '履约模式',
    fulfillmentConsignment: '寄售',
    fulfillmentSelfFulfillment: '自履约',
    fulfillmentConsignmentDesc: '送仓实物库存，平台履约',
    fulfillmentSelfFulfillmentDesc: '虚拟库存，商户自己发货',
    fulfillmentTypeRequired: '请至少选择一种履约模式',
    requestedFulfillmentTypes: '申请的履约模式',
    approvedFulfillmentTypes: '已批准的履约模式',
    pricingModel: '定价模式',
    pricingSelf: '自主定价',
    pricingPlatformManaged: '平台托管',
    ...
    tabDisabled: '已禁用',
    // Approve
    approveApplication: '审批渠道申请',
    approveHint: '请选择批准的履约模式，商户只能使用被批准的模式',
    selectApprovedFulfillmentTypes: '选择批准的履约模式',
    atLeastOneFulfillmentType: '请至少选择一种履约模式',
    confirmApprove: '确认审批',
    confirmApproveDesc: '确定通过商户「{{merchant}}」对渠道「{{channel}}」的接入申请吗？',
    // Reject
    rejectTitle: '拒绝申请',
    confirmReject: '确认拒绝',
    confirmRejectDesc: '确定拒绝商户「{{merchant}}」对渠道「{{channel}}」的接入申请吗？',
    rejectReason: '拒绝原因',
  ...
  inventory: {
    ...
    selectSalesChannel: '选择销售渠道',
    selectChannelFirst: '请先选择销售渠道',
    noActiveChannels: '暂无可用的销售渠道',
    noActiveChannelsDesc: '您需要先申请并通过销售渠道审核才能创建入库单',
    goToApplyChannels: '前往申请销售渠道',
    noWarehousesForChannel: '该渠道暂无可用仓库',
    noWarehousesForChannelError: '无法创建入库单',
    noWarehousesForChannelDesc: '该销售渠道尚未配置仓库，请联系平台管理员',
    noWarehousesAvailable: '没有可用的仓库',
